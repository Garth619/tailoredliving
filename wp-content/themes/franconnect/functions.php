...
function slideshowtoronto_shortcode() {
    ...
    return '<div class="slideshow_wrapper">
	    ...
	    <div class="slide">
		    ...
		    <img class="img_slide" src="' . get_bloginfo('template_directory') . '/images/tor1.jpg"/>
		    <div class="my_captions">
	    ...
	    <div class="slide">
		    ...
		    <img class="img_slide" src="' . get_bloginfo('template_directory') . '/images/tor2.jpg"/>
		    <div class="my_captions">
...
add_shortcode('slideshowtoronto', 'slideshowtoronto_shortcode');
